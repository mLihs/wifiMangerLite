...
// Keep HTML helpers in a header to keep AdvancedCaptivePortal.ino easier to read.
...
static String buildExtendedStatusPageHtml(WML::WiFiManagerLite& wifiMgr,
                                         const WML::Config& cfg,
...
<body>
  <div class="app">
    <div class="page-header">
      ...
      <div class="subtitle">Advanced Status & Configuration</div>
    </div>
    ...
    <div class="card">
      ...
      <div class="status-list">
        ...
        <div class="status-item">
          <span class="status-label">BSSID</span>
          <span class="status-value">)rawhtml" + (wifiMgr.isConnected() ? wifiMgr.getBSSID() : "—") + R"rawhtml(</span>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="status-list">
        <div class="status-item">
          ...
          <span class="status-value">)rawhtml" + formatUptime(uptimeSeconds) + R"rawhtml(</span>
        </div>
        <div class="status-item">
          <span class="status-label">Free Heap</span>
          <span class="status-value">)rawhtml" + String(ESP.getFreeHeap() / 1024) + R"rawhtml( KB</span>
        </div>
        <div class="status-item">
          <span class="status-label">Chip Model</span>
          <span class="status-value">)rawhtml" + String(ESP.getChipModel()) + R"rawhtml(</span>
        </div>
        <div class="status-item">
          <span class="status-label">Chip Revision</span>
          <span class="status-value">)rawhtml" + String(ESP.getChipRevision()) + R"rawhtml(</span>
        </div>
        <div class="status-item">
          <span class="status-label">CPU Frequency</span>
          <span class="status-value">)rawhtml" + String(ESP.getCpuFreqMHz()) + R"rawhtml( MHz</span>
        </div>
        <div class="status-item">
    ...
    <div class="page-footer">
      )rawhtml" + String(cfg.deviceName) + R"rawhtml( · Firmware 1.2.0<br>
      <a href="/api/status" style="color:var(--accent-pink);text-decoration:none">JSON API</a> · 
      <a href="/api/system" style="color:var(--accent-pink);text-decoration:none">System API</a>
    </div>
  </div>
